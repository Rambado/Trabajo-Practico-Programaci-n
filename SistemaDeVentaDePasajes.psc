...
//Subproceso BuscarPasajePorAsiento()
    // Implementar la búsqueda de pasaje por número de asiento
//FinSubproceso

//Subproceso BuscarPasajePorNombreApellido()
    // Implementar la búsqueda de pasaje por nombre y apellido
//FinSubproceso

//Subproceso OrdenarYMostrarListaPasajeros()
    // Implementar la ordenación y muestra de la lista de pasajeros
//FinSubproceso

//Subproceso Listados(asientos_disponibles, capacidad_pasajeros, rutas_aereas)
    // Implementar los listados de cantidad de pasajes vendidos y porcentaje de ventas por ruta aérea
//FinSubproceso